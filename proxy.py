...
TELEGRAM_BOT_TOKEN = '7666217142:AAEWt29kPa6lHtyLF7jfUWhO0MyYXoElzhI'
ADMIN_USER_ID = 1837154602
...
async def run_attack(chat_id, ip, port, time, context):
    ...
    try:
        ...
        attack_in_progress = False
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed ✅*\n*🔥 Owner @RAJOWNER90*\n*🔥 SERVER @RAJOWNER90_BOT*", parse_mode='Markdown')
